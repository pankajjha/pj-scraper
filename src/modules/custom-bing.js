...
const debug = require('debug')('pj-scraper:CustomBingScraper');

class CustomBingScraper extends Scraper {
...
class CustomBingNewsScraper extends Scraper {
...
module.exports = {
    CustomBingScraper: CustomBingScraper,
    CustomBingNewsScraper: CustomBingNewsScraper,
};