...
fakeSearchEngine.get('/search', (req, res) => {
    ...
    res.sendFile(path.join(__dirname, '../mocks/google-desktop/' + req.query.q + '_page' + pageNumber + '.html'));
});
fakeSearchEngine.use(express.static('test/mocks/google-desktop', {extensions: ['html']}));
