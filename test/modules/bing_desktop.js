...
fakeSearchEngine.get('/search', (req, res) => {
    ...
    res.sendFile(path.join(__dirname, '../mocks/bing-desktop/' + req.query.q + '_page' + pageNumber + '.html'));
});
fakeSearchEngine.use(express.static('test/mocks/bing-desktop', {extensions: ['html']}));
